 ...
 */
declare const AUTH_FORM_COLUMN_CLASS = "relative mx-auto min-w-0 w-[min(100%,360px)] shrink-0";
declare const AUTH_PRIMARY_CTA_CLASS = "h-11 w-full";
/** Compact OAuth: always 2 columns, tight gap. */
declare const AUTH_OAUTH_GRID_CLASS = "grid grid-cols-2 gap-2";
/** Compact OAuth chip — fills grid cell only. */
declare const AUTH_OAUTH_BUTTON_CLASS = "h-9 w-full justify-center gap-2 border-border bg-background px-2.5 text-sm font-medium text-foreground shadow-none hover:bg-muted";

export { AUTH_FORM_COLUMN_CLASS, AUTH_OAUTH_BUTTON_CLASS, AUTH_OAUTH_GRID_CLASS, AUTH_PRIMARY_CTA_CLASS };
